...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    setLoading(true);
    try {
      const res = await axios.post('http://localhost:6789/a/register', { username, email, password }, { withCredentials: true });
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Tên người dùng" value={username} onChangeText={setUsername} autoCapitalize="none" />
