...
export default function Test({ vocabularyData, setVocabularyData, selectedTest, selectedCategory, setTab }: TestProps) {
	...
	const words = vocabularyData[selectedTest]?.find((cat) => cat.Category === selectedCategory)?.Words || [];
						...
						<div className="min-w-[300px] min-h-[400px]">
							<div className="flex items-center gap-2">
								<div className="text-xl font-semibold">
									{words[currentWordIndex]["Từ vựng"]}
								</div>
								<button
