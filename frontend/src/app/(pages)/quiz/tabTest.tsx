  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="p-4 bg-[#323232] rounded-lg max-h-screen custom-scroll pb-[170px] md:pb-[10px]">
        ...
        {showTranslation && (
          <p className="mt-2">
            <strong>Dịch nghĩa:</strong> {currentQuestion.vietnamese_translation}
          </p>
        )}
        {showHint && (
          <p className="mt-2">
