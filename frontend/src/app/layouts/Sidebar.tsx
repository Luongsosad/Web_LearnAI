      ...
      >
        <div>
          ...
          <div className="p-4 space-y-2">
            ...
            <NavItem icon={MessageCircle} label="Chat AI" onClick={() => {
            ...
            <NavItem icon={Headphones} label="Giao tiếp" onClick={() => {
            ...
            <NavItem icon={BookOpen} label="Flashcard" onClick={() => {
              if (user && user.plan_id >= 1) {
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 justify-center">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    <LogOut
                      className={`w-4 h-4 ${isLoggingOut
                        ? "text-gray-500"
